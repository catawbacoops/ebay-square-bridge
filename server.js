  ...
  const xml = itemNode
        .ele("ShippingDetails")
          ...
          .ele("CalculatedShippingRate")
            .ele("WeightMajor", { unit: "lbs", measurementSystem: "English" }).txt(String(weightPounds)).up()
            .ele("WeightMinor", { unit: "oz", measurementSystem: "English" }).txt(String(weightOunces)).up()
